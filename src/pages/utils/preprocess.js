...
export function thresholdFilter(pixels, level) {
  if (level === undefined) {
    level = 0.5;
  }
...
export function setPixels(pixels, data) {
  let offset = 0;
...
// from https://github.com/processing/p5.js/blob/main/src/image/filters.js
export function blurARGB(pixels, canvas, radius) {
...
// from https://github.com/processing/p5.js/blob/main/src/image/filters.js
export function dilate(pixels, canvas) {
  let currIdx = 0;
